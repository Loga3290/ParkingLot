...
public class StadiumFWTimeBlockFactory {
    ...
    private TimeBlock block1 = new ZeroToFourHourTimeBlock(0L, 4L, 60);
    private TimeBlock block2 = new FourToTwelveHourTimeBlock(4L, 12L, 120);
    private TimeBlock block3 = new TwelveToInfinityHourTimeBlock(12L, 1440L, 200, Arrays.asList(block1, block2));
