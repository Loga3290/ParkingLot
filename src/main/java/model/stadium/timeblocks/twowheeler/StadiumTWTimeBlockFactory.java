...
public class StadiumTWTimeBlockFactory  {
    private final TimeBlock block1 = new ZeroToFourHourTimeBlock(0L, 4L, 30);
    private final TimeBlock block2 = new FourToTwelveHourTimeBlock(4L, 12L, 60);
    private final TimeBlock block3 = new TwelveToInfinityHourTimeBlock(12L, 1440L, 100, Arrays.asList(block1, block2));
