...
public class AirportTWTimeBlockFactory {
    ...
    private final TimeBlock block1 = new ZeroToOneHourTimeBlock(0L, 1L, 0);
    private final TimeBlock block2 = new OneToEightHourTimeBlock(1L, 8L, 40);
    private final TimeBlock block3 = new EightToTwentyFourHourTimeBlock(8L, 24L, 60);
    private final TimeBlock block4 = new TwentyFourToInfinityHourTimeBlock(24L, 1440L, 80);
